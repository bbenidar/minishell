...
#    Updated: 2023/08/10 19:01:40 by bbenidar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =  	./parsing/first_check.c ./parsing/first_check_2.c ./parsing/check_utils.c minishell.c ./utils/utils3.c ./lexical/ft_dell_space.c \
		...
		./parsing/splite_utile.c  ./utils/utils4.c ./utils/itoa.c ./execution/execut.c  ./lexical/ft_last_list.c ./lexical/ft_last_list_utils.c ./execution/builting/echo.c\
